...
## How to Run
Download the folder and open it in GOLand IDE. You are then able to right click the files in their directories to run, or from the drop down menu above.
(Ignore the default main file)
